              ...
              child: Column(
                children: [
                  ...
                  SwitchListTile(
                    ...
                    title: Text(l10n.settingsLoggingReminders),
                    subtitle: Text(l10n.settingsLoggingRemindersDesc),
                  ...
                  ListTile(
                    ...
                    title: Text(l10n.settingsSmsSummaries),
                    subtitle: Text(l10n.settingsSmsSummariesDesc),
                    trailing: Icon(Icons.chevron_right_rounded,
                        color: RhythmaColors.mutedFg),
                    onTap: () {
                      Navigator.push(
