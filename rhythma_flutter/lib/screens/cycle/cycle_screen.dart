  ...
  Future<void> _deleteCycleLog() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(l10n.cycleDeleteEntry),
        content: Text(l10n.cycleDeleteEntryConfirm),
        actions: [
          TextButton(
          ...
          if (hasSelections) ...[
            ...
            Center(
              child: TextButton.icon(
                ...
                label: Text(l10n.cycleDeleteLog),
                style: TextButton.styleFrom(
