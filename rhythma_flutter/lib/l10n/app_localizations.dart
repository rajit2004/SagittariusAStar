...
abstract class AppLocalizations {
  ...
  /// No description provided for @cycleDeleteEntryConfirm.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to delete this day\'s log? This cannot be undone.'**
  String get cycleDeleteEntryConfirm;

  /// No description provided for @cycleSaveLog.
  ///
  /// In en, this message translates to:
  /// **'Save Log'**
  String get cycleSaveLog;

  /// No description provided for @cycleDeleteLog.
  ///
  /// In en, this message translates to:
  /// **'Delete Log'**
  String get cycleDeleteLog;

  /// No description provided for @cycleSavedToAccount.
  ///
  /// In en, this message translates to:
  /// **'Saved to your account'**
  String get cycleSavedToAccount;

  /// No description provided for @cycleSavedOffline.
  ///
  /// In en, this message translates to:
  /// **'Saved on this device. Will sync automatically when you\'re back online.'**
  String get cycleSavedOffline;

  /// No description provided for @homeSavedOffline.
  ///
  /// In en, this message translates to:
  /// **'Saved on this device — couldn\'t reach the server yet.'**
  String get homeSavedOffline;
  ...
  /// No description provided for @cycleNoLogs.
  ///
  /// In en, this message translates to:
  /// **'No logs yet'**
  String get cycleNoLogs;

  /// No description provided for @settingsLoggingReminders.
  ///
  /// In en, this message translates to:
  /// **'Logging Reminders'**
  String get settingsLoggingReminders;

  /// No description provided for @settingsLoggingRemindersDesc.
  ///
  /// In en, this message translates to:
  /// **'Remind to log if no data for today'**
  String get settingsLoggingRemindersDesc;
  ...
  /// No description provided for @settingsSmsSummaries.
  ///
  /// In en, this message translates to:
  /// **'SMS Cycle Summaries'**
  String get settingsSmsSummaries;

  /// No description provided for @settingsSmsSummariesDesc.
  ///
  /// In en, this message translates to:
  /// **'Get a text summary sent to your phone'**
  String get settingsSmsSummariesDesc;
  ...
  /// No description provided for @settingsUnderDevelopment.
  ///
  /// In en, this message translates to:
  /// **'This feature is currently under development.'**
  String get settingsUnderDevelopment;
  ...
  /// No description provided for @insightsCycleStats.
  ///
  /// In en, this message translates to:
  /// **'CYCLE STATISTICS'**
  String get insightsCycleStats;

  /// No description provided for @insightsExportReport.
  ///
  /// In en, this message translates to:
  /// **'Export Health Report'**
  String get insightsExportReport;

  /// No description provided for @insightsExportReportDesc.
  ///
  /// In en, this message translates to:
  /// **'Generate your health summary as a PDF'**
  String get insightsExportReportDesc;

  /// No description provided for @insightsReportSuccess.
  ///
  /// In en, this message translates to:
  /// **'Health report generated successfully'**
  String get insightsReportSuccess;
}
